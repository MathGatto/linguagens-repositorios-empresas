...
class ManipulaRpositorios:

    def __init__(self, username):
        self.username = username
        self.api_base_url = 'https://api.github.com'
        self.access_token = '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'
    ...
    def cria_repo(self, nome_repo):
        data = {
            'name': nome_repo,
            'description': 'Dados dos repositórios de algumas empresas que estão no Github',
            'private': False
        }
    ...
    def add_arquivo(self, nome_repo, nome_arquivo, caminho_arquivo, message):
